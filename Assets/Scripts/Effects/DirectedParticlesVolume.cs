...
public class DirectedParticlesVolume : MonoBehaviour {
    ...
    public void EnableDirectionControl( float refresh_time ) { enable_direction = true; direction_refresh_time = refresh_time; StartCoroutine( DirectionControl() ); }
	...
	IEnumerator DirectionControl() {
        ...
        while( enable_direction ) {
            ...
            cached_transform.LookAt( tracking_transform );
            cached_transform.Rotate( 0f, 180f, 0f );
